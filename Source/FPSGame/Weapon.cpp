...
AWeapon::AWeapon()
{
	...
	if (!MeshComponent)
	{
		...
		static ConstructorHelpers::FObjectFinder<USkeletalMesh>Mesh(TEXT("'/Game/FPWeapon/Mesh/SK_FPGun.SK_FPGun'"));
        if(Mesh.Succeeded())
        {
		...
		static ConstructorHelpers::FObjectFinder<UMaterial>Material(TEXT("'/Game/FPWeapon/Materials/M_FPGun.M_FPGun'"));
