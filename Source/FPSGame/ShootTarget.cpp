...
AShootTarget::AShootTarget()
{
	...
	if (!MeshComponent)
	{
		...
		static ConstructorHelpers::FObjectFinder<UStaticMesh>Mesh(TEXT("'/Game/FPTarget/Cylinder.Cylinder'"));
        if(Mesh.Succeeded())
        {
		...
		static ConstructorHelpers::FObjectFinder<UMaterial>Material(TEXT("'/Game/FPTarget/TargetMaterial.TargetMaterial'"));
